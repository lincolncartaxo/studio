    ...
    <footer className="bg-secondary/50 py-12 px-4 md:px-6 mt-16">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-secondary-foreground">
        ...
        <div className="flex flex-col gap-2">
          ...
          <a href="https://wa.me/5583987722871" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors">
            <Phone className="w-4 h-4" />
            <span>+55 (83) 98772-2871</span>
          </a>
